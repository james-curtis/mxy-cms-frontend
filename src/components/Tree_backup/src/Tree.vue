...
export default defineComponent({
  ...
  setup(props, { attrs, slots, emit, expose }) {
    ...
    watchEffect(() => {
      if (props.searchValue !== searchText.value)
        searchText.value = props.searchValue;
    });
    ...
    function handleSearch(searchValue: string) {
      ...
      const { filterFn, checkable, expandOnSearch, checkOnSearch } =
        unref(props);
