<template>
  <div>
    <template
      ...
      :key="fileKey"
    >
      <a-input :read-only="true" :value="file.name">
        ...
        <template
          v-if="
            originColumn.allowDownload !== false ||
            originColumn.allowRemove !== false
          "
          #addonAfter
        >
          <Dropdown :trigger="['click']" placement="bottomRight">
            ...
            <template #overlay>
              <a-menu>
                ...
                >
                  <span
                    ><Icon icon="ant-design:delete-outlined" />&nbsp;删除</span
                  >
                </a-menu-item>
              </a-menu>
            </template>
    ...
    >
      <a-button pre-icon="ant-design:upload-outlined">
