  ...
  <div style="width: 100%">
    ...
    <div :class="`flex items-center ${prefixCls}__table-title-box`">
      ...
      <div :class="`${prefixCls}__toolbar`">
        ...
        />
        <a-popover
          :overlay-class-name="`${prefixCls}__toolbar-mobile`"
          trigger="click"
          placement="left"
          :get-popup-container="(n) => n.parentElement"
        >
          <template #content>
            <TableSetting
              v-if="showTableSetting"
...
export default defineComponent({
  ...
  setup(_, { emit }) {
    ...
    const { getSelectRowKeys, setSelectedRowKeys, getRowSelection } =
      useTableContext();
