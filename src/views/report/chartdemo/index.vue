  ...
  <div class="p-4">
    <a-card :bordered="false" style="height: 100%">
      <a-tabs v-model:activeKey="activeKey" animated @change="tabChange">
        ...
        >
          <Bar :chart-data="barDataSource" width="30%" height="50vh" />
        </a-tab-pane>
        ...
        <a-tab-pane
          ...
          style="display: flex; justify-content: center"
        >
          <Line :chart-data="barDataSource" width="30%" height="50vh" />
        </a-tab-pane>
        ...
        <a-tab-pane key="8" tab="雷达图">
          <Radar :chart-data="radarData" height="50vh" />
        </a-tab-pane>
        <a-tab-pane key="9" tab="仪表盘">
          <Gauge :chart-data="{ name: '出勤率', value: 70 }" height="50vh" />
        </a-tab-pane>
        <a-tab-pane key="10" tab="折柱图">
          <BarAndLine :chart-data="barLineData" height="50vh" />
        </a-tab-pane>
...
const { barDataSource, barMultiData, pieData, barLineData, radarData } =
  getData;
