...
export function useFormRules(formData?: Recordable) {
  ...
  const getRegisterAccountRule = computed(() =>
    createRegisterAccountRule('account')
  );
  const getRegisterMobileRule = computed(() =>
    createRegisterAccountRule('mobile')
  );
  ...
  const getFormRules = computed(
    (): { [k: string]: ValidationRule | ValidationRule[] } | any => {
