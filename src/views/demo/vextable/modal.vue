      ...
      <a-row class="form-row" :gutter="16">
        <a-col :lg="8">
          <a-form-item label="订单号" name="orderCode">
            <a-input
              v-model:value="orderMainModel.orderCode"
              placeholder="请输入订单号"
            />
          </a-form-item>
        </a-col>
        <a-col :lg="8">
          <a-form-item label="订单类型">
            <a-select
              v-model:value="orderMainModel.ctype"
              placeholder="请选择订单类型"
            >
      ...
      <a-row class="form-row" :gutter="16">
        <a-col :lg="8">
          <a-form-item label="订单金额">
            <a-input
              v-model:value="orderMainModel.orderMoney"
              placeholder="请输入订单金额"
            />
          </a-form-item>
        </a-col>
        <a-col :lg="8">
          <a-form-item label="订单备注">
            <a-input
              v-model:value="orderMainModel.content"
              placeholder="请输入订单备注"
            />
          </a-form-item>
        </a-col>
        ...
        <a-tab-pane key="1" tab="客户信息">
          <div>
            ...
            >
              ...
              <a-col :span="5">
                <a-form-item>
                  <a-input v-model:value="item.name" placeholder="客户名" />
                </a-form-item>
              </a-col>
              <a-col :span="5">
                <a-form-item>
                  <a-select v-model:value="item.sex" placeholder="性别">
              ...
              <a-col :span="6">
                ...
                >
                  <a-input v-model:value="item.idcard" placeholder="身份证号" />
                </a-form-item>
              </a-col>
              <a-col :span="6">
                <a-form-item
                  :name="['jeecgOrderCustomerList', index, 'telphone']"
                >
                  <a-input v-model:value="item.telphone" placeholder="手机号" />
                </a-form-item>
              </a-col>
              <a-col :span="2">
                <a-form-item>
        ...
        <a-tab-pane key="2" tab="机票信息" force-render>
          ...
          >
            ...
            <a-col :span="6">
              ...
              >
                <a-input v-model:value="item.ticketCode" placeholder="航班号" />
              </a-form-item>
            </a-col>
            <a-col :span="6">
              <a-form-item>
