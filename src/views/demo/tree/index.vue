    ...
    <Row :gutter="[16, 16]">
      ...
      <Col :span="8">
        <Card title="异步数据，默认展开">
          <template #extra>
            <a-button :loading="treeLoading" @click="loadTreeData">
              加载数据
            </a-button>
          </template>
      ...
      <Col :span="8">
        <Card title="BasicTree内置加载">
          <template #extra>
            <a-button :loading="treeLoading" @click="loadTreeData2">
              请求数据
            </a-button>
          </template>
          <BasicTree
...
import type { TreeActionType, TreeItem } from '/@/components/Tree/index';
