<template>
  <PageWrapper title="Tree函数操作示例" content-background content-class="p-4">
    <div class="mb-4">
    ...
    <div class="mb-4">
      <a-button class="mr-2" @click="handleSetCheckData">
        设置勾选数据
      </a-button>
      <a-button class="mr-2" @click="handleGetCheckData">
        获取勾选数据
      </a-button>
      <a-button class="mr-2" @click="handleSetSelectData">
        设置选中数据
      </a-button>
      <a-button class="mr-2" @click="handleGetSelectData">
        获取选中数据
      </a-button>

      <a-button class="mr-2" @click="handleSetExpandData">
        设置展开数据
      </a-button>
      <a-button class="mr-2" @click="handleGetExpandData">
        获取展开数据
      </a-button>
    </div>
    <div class="mb-4">
      <a-button class="mr-2" @click="appendNodeByKey(null)">
        添加根节点
      </a-button>
      <a-button class="mr-2" @click="appendNodeByKey('2-2')">
        添加在parent3内添加节点
      </a-button>
      <a-button class="mr-2" @click="deleteNodeByKey('2-2')">
        删除parent3节点
      </a-button>
      <a-button class="mr-2" @click="updateNodeByKey('1-1')">
        更新parent2节点
      </a-button>
    </div>
    <BasicTree
...
import type { TreeActionType } from '/@/components/Tree/index';
