    ...
    >
      <a-row>
        ...
        <a-col :span="24">
          ...
          >
            <JCheckbox
              v-model:value="formState.duoxuan"
              dict-code="urgent_level"
              placeholder="请选择字典多选"
            />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.shijian"
          >
            <TimePicker
              v-model:value="formState.shijian"
              placeholder="请选择时间"
              style="width: 100%"
            />
          </a-form-item>
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.tupian"
          >
            <JImageUpload v-model:value="formState.tupian" :file-max="2" />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.dhwb"
          >
            <a-textarea
              v-model:value="formState.dhwb"
              rows="4"
        ...
        <a-col :span="24">
          ...
          >
            <JPopup
              ...
              code="report_user"
              :multi="true"
              :set-fields-value="setFieldsValue"
            />
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.bmxz"
          >
            <JSelectDept
              v-model:value="formState.bmxz"
              :multi="true"
              type="array"
            />
          </a-form-item>
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.yongHu"
          >
            <JSelectUser
              v-model:value="formState.yongHu"
              placeholder="请选择用户"
            />
          </a-form-item>
        </a-col>
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.yuanjia"
          >
            <a-input-number
              v-model:value="formState.yuanjia"
              placeholder="请输入double类型"
              style="width: 100%"
            />
          </a-form-item>
        </a-col>
        <a-col :span="24">
          ...
          >
            <a-input
              v-model:value="formState.ywzz"
              placeholder="请输入2到10位的字母"
            />
          </a-form-item>
        </a-col>
        <a-col :span="24">
        ...
        <a-col :span="24">
          <a-form-item
            ...
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            v-bind="validateInfos.jsonParam"
          >
...
const validatorRules = {
  ...
  ywzz: [
    { required: false },
    { pattern: '^[a-z|A-Z]{2,10}$', message: '不符合校验规则!' },
  ],
