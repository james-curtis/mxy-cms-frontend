<template>
  <PageWrapper title="消息示例">
    <CollapseContainer class="w-full h-32 bg-white rounded-md" title="Message">
      ...
      <a-button class="mr-2" color="error" @click="errorMsg('Error message')">
        Error
      </a-button>
      <a-button class="mr-2" type="primary" @click="handleLoading">
        Loading
      </a-button>
    </CollapseContainer>
    ...
    >
      ...
      <a-button color="warning" class="mr-2" @click="handleConfirm('warning')">
        Warning
      </a-button>
      <a-button color="success" class="mr-2" @click="handleConfirm('success')">
        Success
      </a-button>
      <a-button color="error" class="mr-2" @click="handleConfirm('error')">
        Error
      </a-button>
    </CollapseContainer>
    ...
    >
      ...
      <a-button color="success" class="mr-2" @click="handleSuccessModal">
        Success
      </a-button>
      <a-button color="error" class="mr-2" @click="handleErrorModal">
        Error
      </a-button>
      <a-button color="warning" class="mr-2" @click="handleWarningModal">
        Warning
      </a-button>
    </CollapseContainer>
    ...
    >
      <a-button color="success" class="mr-2" @click="handleNotify">
        Success
      </a-button>
    </CollapseContainer>
  </PageWrapper>
