<template>
  <PageWrapper title="全屏示例">
    ...
    >
      <a-button type="primary" class="mr-2" @click="enter">
        Enter Window Full Screen
      </a-button>
      <a-button color="success" class="mr-2" @click="toggle">
        Toggle Window Full Screen
      </a-button>

      <a-button color="error" class="mr-2" @click="exit">
    ...
    >
      <a-button type="primary" class="mr-2" @click="toggleDom">
