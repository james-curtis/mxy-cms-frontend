...
export const getTomcatSessionsActiveCurrent = () => {
  return defHttp.get(
    { url: Api.tomcatSessionsActiveCurrent },
    { isTransformResponse: false }
  );
};
...
export const getTomcatSessionsActiveMax = () => {
  return defHttp.get(
    { url: Api.tomcatSessionsActiveMax },
    { isTransformResponse: false }
  );
};
...
export const getTomcatSessionsRejected = () => {
  return defHttp.get(
    { url: Api.tomcatSessionsRejected },
    { isTransformResponse: false }
  );
};
