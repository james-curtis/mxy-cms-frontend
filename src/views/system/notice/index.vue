<template>
  <div>
    ...
    <DetailModal :frame-src="iframeUrl" @register="register" />
  </div>
</template>
...
// 列表页面公共参数、方法
const { prefixCls, onExportXls, onImportXls, tableContext, doRequest } =
  useListPage({
...
function handleDetail(record) {
  iframeUrl.value = `${glob.uploadUrl}/sys/annountCement/show/${
    record.id
  }?token=${getToken()}`;
  openDetail(true);
}
