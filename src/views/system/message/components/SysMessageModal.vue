<template>
  ...
  >
            ...
            >
              <template #content>
                ...
                <div class="search-date">
                  ...
                  <div class="date-tags">
                    ...
                    <div v-if="showRangeDate" class="cust-range-date">
                      <a-range-picker
                        v-model:value="searchRangeDate"
              ...
              <span v-if="conditionStr" class="anticon filtera">
                ...
                <span style="display: flex; margin: 0 5px"
                  ><close-outlined style="font-size: 12px" @click="clearAll"
                /></span>
              </span>
    ...
    <div class="sys-message-card">
      <a-tabs :active-key="activeKey" center @tabClick="handleChangePanel">
        <template #renderTabBar>
          <div />
        </template>

        <a-tab-pane key="all" tab="全部消息" force-render>
          <sys-message-list
            ref="allMessageRef"
            @close="hrefThenClose"
        ...
        <!-- 标星 -->
        <a-tab-pane key="star" tab="标星消息" force-render>
          <sys-message-list
            ref="starMessageRef"
            star
            @close="hrefThenClose"
