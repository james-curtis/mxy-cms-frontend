<template>
  <div>
    ...
    <div
      v-if="customSearch"
      class="jeecg-basic-table-form-container"
    ...
    >
      ...
      <template #tableTitle>
        ...
        <a-upload
          ...
          :custom-request="
            (file) => handleImportXls(file, getImportUrl, reload)
          "
        >
          <a-button pre-icon="ant-design:import-outlined" type="primary">
            导入
          </a-button>
        </a-upload>
        <a-button
        ...
        <a-button pre-icon="ant-design:filter" type="primary" @click="">
          高级查询?
        </a-button>
        <a-button
          pre-icon="ant-design:plus-outlined"
        ...
        <a-button
          pre-icon="ant-design:retweet-outlined"
          type="primary"
    ...
    <JImportModal :url="getImportUrl" online @register="registerModal1" />
  </div>
</template>
