...
export const TypePicker = createAsyncComponent(
  () => import('./TypePicker.vue')
);
...
export const SwitchItem = createAsyncComponent(
  () => import('./SwitchItem.vue')
);
export const SelectItem = createAsyncComponent(
  () => import('./SelectItem.vue')
);
